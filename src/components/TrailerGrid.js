    ...
    "Trending Trailers": [
        {
            ...
            VideoUrl: "/assets/videos/mara_mittar.mp4"
        },
        {
            id: 2,
            Title: "I Am Legend",
                    ...
                    <div key={trailer.id} className="trailer-card">
                        ...
                        <div className="poster-container">
                            {playingTrailer === trailer.id ? (
                                ...
                                //     allowFullScreen
                                // />
                                <video autoPlay width="100%" height="300px" src={trailer.VideoUrl} title={trailer.Title} allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></video>
                            ) : trailer.Poster ? (
